			    	...
			    	<div class="row align-items-center justify-content-between d-flex">
				      ...
				      <nav id="nav-menu-container">
						<ul class="nav-menu">
							...
							<li><a href='{{ route("pets", ["pet_cat" => $category->id]) }}'>{{$category->name}}</a></li>
							@endforeach
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-cat-list">
							  <img src="{{ asset('/public/img/'.$animal->image) }}" alt="" class="img-fluid">
							  <div class="overlay">
							    <div class="text">
								<p>{{$animal->name}}</p>
								@if($logged_in)
								<p><a href="{{route('adopt', ['id' => $animal->id])}}" style="color: white"><u>Adopt me!</u></a></p>
								@endif
								</div>
							  </div>
							</div>
